...
package com.idcq.appserver.dao;
...
import com.idcq.appserver.utils.Assert;
...
//	protected GtaJdbcBaseDao jdbcBaseDao;
	 ...
	 * @throws Exception
	 */
//	public Object getResult(String repCode,Map<String, Object>queryParam)throws DataAccessException, Exception
//	{
//		return this.jdbcBaseDao.getRepResult(repCode, queryParam);
//	}
	 ...
	 * @throws Exception
	 */
//	public PageModel pagingResult(String repCode,Map<String, Object>queryParam)throws DataAccessException, Exception
//	{
//		return this.jdbcBaseDao.pagingResult(repCode, queryParam);
//	}
