package com.idcq.appserver.utils.pinyin;
...
public class PinyinUtil {
    ...
    public static String getPinYinHeadChar(String chinese) {
        if(StringUtils.isNotBlank(chinese) && chinese.length() == 1) {
            return getPinYinHeadCharOne(chinese);
        }
    ...
    public static String getPinyinConvertJianPin(String chinese) {
        ...
        if(StringUtils.isNotBlank(pinyin)) {
            if(pinyin.length() > 450) {
                pinyin = pinyin.substring(0, 450);
            } else {
    ...
    public static void main(String[] args) throws BadHanyuPinyinOutputFormatCombination {
        String str = "2010西斯塔酒庄柯其塔查缇欧桑娇维塞干红";
...
//        System.out.println("首字母大写输出：" + getPinyinFirstToUpperCase(str));
        System.out.println("简拼输出：" + getPinYinHeadChar(str));
